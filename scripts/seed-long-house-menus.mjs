...
const SET_MENUS = {
  ...
  2: { // Tuesday
    starters: [
      dish('Grilled Coriander Seafood', null),
      veg('Cream of Cauliflower Soup', null),
      dish('Chicken Croquettes', null),
      REFRESHER,
    ],
    mains: [
      dish('Pan-Fried Barramundi', null),
      veg('Miso Glazed Tofu', null),
      dish('Pork Piccata', null),
    ],
    desserts: [
      dish('Chocolate Banana Tart', null),
      dish('Coconut Panna Cotta', null),
      FRUIT,
    ],
    chefsSpecial: KOTTU,
  },
  3: { // Wednesday
    starters: [
      dish('Asian Crispy Squid', null),
      dish('French Onion Soup', null),
      veg('Fried Lentil Fritters', null),
      REFRESHER,
    ],
    mains: [
      dish('Stir Fried Seafood & Cashew Nut', null),
      veg('Linguine Tomato Cream', null),
      dish('Slow-Cooked Curried Beef Stew Pie', null),
    ],
    desserts: [
      dish('Warm Chocolate Fondant', null),
      dish('Mango Crumble', null),
      FRUIT,
    ],
  ...
  4: { // Thursday
    starters: [
      dish('Beer Battered Fish', null),
      veg('Vegetable Minestrone Soup', null),
      dish('Thai Beef Salad', null),
      REFRESHER,
    ],
    mains: [
      dish('Fried Crispy Prawns', null),
      veg('Vegetable Lasagna', null),
      dish('Mushroom Stuffed Chicken', null),
    ],
    desserts: [
      dish('Lime Curd Meringue Tart', null),
      dish('Tres Leches Cake', null),
      FRUIT,
    ],
    chefsSpecial: KOTTU,
  },
  5: { // Friday
    starters: [
      dish('Asian Salad Niçoise', null),
      veg('Curried Pumpkin Soup', null),
      dish('Herb Crusted Beef Carpaccio', null),
      REFRESHER,
    ],
    mains: [
      dish('Grilled Garlic Prawn', null),
      veg('String Hopper Pilaf', null),
      dish('Sri Lankan Pan Fried Kottu Roti', 'Chicken / Beef / Pork / Vegetable'),
    ],
    desserts: [
      dish('Coconut & Sago Pearls', null),
      dish('Fried Churros', null),
      FRUIT,
    ],
    chefsSpecial: RICE_AND_CURRY,
  },
  6: { // Saturday
    starters: [
      dish('Seafood Laksa', null),
      veg('BBQ Tofu Salad', null),
      dish('Pork Pineapple Salad', null),
      REFRESHER,
    ],
    mains: [
      dish('Seafood Kabsa Rice', null),
      veg('Spinach & Cream Cheese Ravioli', null),
      dish('Mountain of Meat Pizza', null),
    ],
    desserts: [
      dish('Pumpkin Custard Cake', null),
      dish('Poached Pineapple Spiced Syrup', null),
      FRUIT,
    ],
    chefsSpecial: STRING_HOPPER,
  },
  0: { // Sunday
    starters: [
      dish('Fish Tikka', null),
      veg('Pakora Platter', null),
      dish('Creamy Leek & Chicken Soup', null),
      REFRESHER,
    ],
    mains: [
      dish('Seafood Pasta', null),
      veg('Paneer Makhani', null),
      dish('Masala Mutton Biryani', null),
    ],
    desserts: [
      dish('Watalappam', null),
      dish('Baked Alaska', null),
      FRUIT,
    ],
    chefsSpecial: RICE_AND_CURRY,
  },
