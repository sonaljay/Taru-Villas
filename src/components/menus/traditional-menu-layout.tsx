...
/**
 * Renders a list of categories (heading + items) with ornamental dividers
 * between them. No outer section wrapper or bottom flourish — compose it inside
 * `TraditionalMenuLayout` or group it directly (e.g. the set-menu view).
 *
 * `startIndex` continues the item animation stagger when rendering multiple
 * lists in sequence.
 */
